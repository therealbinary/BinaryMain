...
if SupportedGames[PlaceId] then 
    ...
    if ScriptState[PlaceId] then
       if ScriptState[PlaceId].ScriptDown == true then game.Players.LocalPlayer:Kick("binary | script down"); while true do end end;
       ...
       if scs then print("successfully loaded binary!") elseif err then game.Players.LocalPlayer:Kick("binary | script caught an error"); while true do end; end;
    end
end 
